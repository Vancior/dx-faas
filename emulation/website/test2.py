...
net.addController('c0', controller=mininet.node.RemoteController,
                  ip='172.17.42.1', port=6652)
...
c0 = net.addDocker(
    ...
    environment={
        'TOPO_NAME': 'c1f2d3_edge',
        'CADVISOR_HOST': '172.17.42.1',
        'CADVISOR_PORT': 9001
    },
    volumes=['/home/hujuntao/gitrepo/dx-proto/emulation/cases:/data/topos',
             '/home/hujuntao/deploy/functions:/data/functions'],
    ports=[8880, 8881, 8882, 8883, 8884, 8885],
    port_bindings={8880: 8880, 8881: 8881, 8882: 8882,
                   8883: 8883, 8884: 8884, 8885: 8885},
    cpu_quota=400000,
    mem_limit='8192m')
...
d0 = net.addDocker(
    ...
    dcmd='python -m dx_emulation.test_function',
    # dcmd='tail -f /dev/null',
    environment={
        'MY_IP': '10.0.3.1',
        'CLOUD_HOST': '10.0.1.1',

...
f2 = net.addDocker(
    ...
    cpu_quota=200000,
    mem_limit='2048m')
net.addLink(f2, s0, cls=mininet.link.TCLink, delay="1ms", bw=20)
...
f3 = net.addDocker(
    ...
    cpu_quota=200000,
    mem_limit='2048m')
net.addLink(f3, s0, cls=mininet.link.TCLink, delay="1ms", bw=20)
...
net.start()
net.ping([c0, f0, f1, f2, f3, d0, d1, d2, d3, d4, d5, d6, d7])
